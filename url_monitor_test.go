...
func TestHeaders(t *testing.T) {
	...
	if assert.NotNil(t, fields["url_monitor_code"]) {
		assert.Equal(t, http.StatusOK, fields["url_monitor_code"])
	}
...
func TestMethod(t *testing.T) {
	...
	assert.NotEmpty(t, fields)
	if assert.NotNil(t, fields["url_monitor_code"]) {
		assert.Equal(t, http.StatusMethodNotAllowed, fields["url_monitor_code"])
	}
...
func TestBody(t *testing.T) {
	...
	assert.NotEmpty(t, fields)
	if assert.NotNil(t, fields["url_monitor_code"]) {
		assert.Equal(t, http.StatusBadRequest, fields["url_monitor_code"])
	}
}
